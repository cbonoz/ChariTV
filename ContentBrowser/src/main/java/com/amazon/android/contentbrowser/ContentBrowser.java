...
public class ContentBrowser implements IContentBrowser, ICancellableLoad {
    ...
    /**
     * Constant for the "donate" action.
     */
    public static final int CONTENT_ACTION_DONATE_FIVE = 20;
    ...
    private Action createSearchAction() {
        ...
        Action search = new Action(CONTENT_ACTION_SEARCH, SEARCH, R.drawable.lb_ic_in_app_search);
    ...
    public List<Action> getContentActionList(Content content) {
        ...
        // Add "Watch From Beginning" button to start content over.
        contentActionList.add(createActionButton(CONTENT_ACTION_DONATE_FIVE,
                R.string.donate,
                R.string.five));
